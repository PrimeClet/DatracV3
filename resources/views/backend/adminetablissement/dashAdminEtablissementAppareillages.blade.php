            ...
            <div class="card-body">
              ...
              <div class="tab-content pt-2" id="borderedTabContent">
                <div class="tab-pane fade show active" id="bordered-home" role="tabpanel" aria-labelledby="home-tab">
                  <table class="table datatable">
	                ...
	                <tbody>
	                  ...
	                  @if(count($appareillageEtablissements) != 0)
                    	@foreach($appareillageEtablissements as $appareillageEtablissement)
                        <tr>
							<td>{{ $appareillageEtablissement->id }}</td>
							<td>{{ $appareillageEtablissement->tarif_structure }}</td>
                            <td>{{ $appareillageEtablissement->appareillage_id }}</td>
							<td>{{ $appareillageEtablissement->etablissement_id }}</td>
							<td class="text-center">
								<button class="btn btn-xs btn-primary">
									<a href="{{ URL::to('dashboard/adminetablissement/show-appareillage') }}/{{ $appareillageEtablissement->id }}">
										Voir
									</a>
								</button>
								...
								<a href="{{ URL::to('dashboard/adminetablissement/edit-appareillage') }}/{{ $appareillageEtablissement->id }}" class="btn"><i class="bi brush-fillt"></i></a>
                ...
                <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="profile-tab">
					<form method="POST" action="{{ route('newAppareillageAdminEtablissement') }}">

            ...
            <div class="card-body">
              ...
              <div class="tab-content pt-2" id="borderedTabContent">
                            ...
                            <div class="modal fade" id="edit{{ $user->id }}" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" enctype="multipart/form-data" action="{{ route('updateAgentAdminEtablissement') }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-6 d-flex flex-column align-content-between">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 d-flex flex-column align-content-between">
														...
														<select name="role" class="form-control">
															<option value="ManagerEtablissement"> Manager </option>
                                                            <option value="ComptableEtablissement"> Comptable </option>
                                                            <option value="TiersPayantEtablissement"> Service Tiers-Payant </option>
                                                            <option value="CaisseEtablissement"> Caissière </option>
														</select>
                                                    </div>
													<div class="col-md-12 d-flex flex-column align-content-between">
                ...
                <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="profile-tab">
					<form method="POST" enctype="multipart/form-data" action="{{ route('newAgentAdminEtablissement') }}">
						@csrf

            ...
            <div class="card-body">
              ...
              <div class="tab-content pt-2" id="borderedTabContent">
                  ...
                  <table class="table datatable">
	                ...
	                <tbody>
	                  ...
	                  @if(count($appareillages) != 0)
                        ...
                        <tr>
							<td>{{ $appareillage->id }}</td>
							<td>{{ $appareillage->libelle }}</td>
                            <td>{{ $appareillage->description }}</td>
							<td class="text-center">
								<button class="btn btn-xs btn-primary">
									<a href="{{ URL::to('dashboard/root/show-appareillage') }}/{{ $appareillage->id }}">
										Voir
									</a>
								</button>
								...
								<a href="{{ URL::to('dashboard/root/edit-appareillage') }}/{{ $appareillage->id }}" class="btn"><i class="bi brush-fillt"></i></a>
                ...
                <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="profile-tab">
					<form method="POST" action="{{ route('newAppareillageSuperAdmin') }}">

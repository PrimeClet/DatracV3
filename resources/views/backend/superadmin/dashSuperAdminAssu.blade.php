...
@section('page-content')
	...
	<!--User Dashboard-->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Gestion des Administrateurs Assurance</h5>
              ...
              <div class="tab-content pt-2" id="borderedTabContent">
	                ...
	                <tbody>
	                  @if(count($users) != 0)
                        ...
                        <tr>
							...
							<td class=""><img src="/assets/photos/roots{{ $user->photo_url }}" alt="" style="width: 60px; height: 40px; border-radius: 5px"> </td>
                            ...
                            <td class="align-middle">{{ $user->assurance_id }}</td>
							...
							<form id="delete-{{$user->id}}" method="post" action="{{route('deleteAssuSuperAdmin',$user->id)}}" style="display: none;">
								@csrf
								@method('DELETE')
							</form>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 d-flex flex-column align-content-between">
                                                    ...
                                                    <input type="text" class="form-control mb-1" value="{{ $user->assurance_id }}" disabled>
                                                </div>
                                        </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal fade" id="edit{{ $user->id }}" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" enctype="multipart/form-data" action="{{ route('updateSuperAdminAssu') }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-6 d-flex flex-column align-content-between">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 d-flex flex-column align-content-between">
														<label class="text-black font-w500">Assurance</label>
                ...
                <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="profile-tab">
					<form method="POST" enctype="multipart/form-data" action="{{ route('newSuperAdminAssu') }}">
						@csrf
						<div class="card border-0 shadow-none mb-0">
							<div class="card-body">
                                <div class="row">
									...
									<div class="col-md-12 d-flex flex-column align-content-between">
										<label class="text-black font-w500">Assurance</label>
										<select name="assurance_id" value="{{old('assurance_id')}}" class="form-control">
                                            @if(count($assurances) !=0)
                                                @foreach ($assurances as $assurance)
                                                    <option value="{{ $assurance->id}}">
                                                        {{ $assurance->nom_assurance }}

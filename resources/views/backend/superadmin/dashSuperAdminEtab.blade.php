...
@section('page-content')
	...
	<!--User Dashboard-->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Gestion des Administrateurs Etablissements</h5>
              ...
              <div class="tab-content pt-2" id="borderedTabContent">
	                ...
	                <tbody>
	                  @if(count($users) != 0)
                        ...
                        <tr>
                            ...
                            <td class="align-middle">{{ $user->etablissement_id }}</td>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 d-flex flex-column align-content-between">
                                                    ...
                                                    <input type="text" class="form-control mb-1" value="{{ $user->etablissement_id }}" disabled>
                                                </div>
                                        </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal fade" id="edit{{ $user->id }}" tabindex="-1">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" enctype="multipart/form-data" action="{{ route('updateSuperAdminEtab') }}">
                                                @csrf
                                                <div class="row">
                                                    <div class="col-md-6 d-flex flex-column align-content-between">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 d-flex flex-column align-content-between">
														<label class="text-black font-w500">Etablissement</label>
                ...
                <div class="tab-pane fade" id="bordered-profile" role="tabpanel" aria-labelledby="profile-tab">
					<form method="POST" enctype="multipart/form-data" action="{{ route('newSuperAdminEtab') }}">
						@csrf
						<div class="card border-0 shadow-none mb-0">
							<div class="card-body">
                                <div class="row">
									...
									<div class="col-md-12 d-flex flex-column align-content-between">
										<label class="text-black font-w500">Etablissement</label>
										<select name="etablissement_id" value="{{old('etablissement_id')}}" class="form-control">
                                            @if(count($etablissements) !=0)
                                                @foreach ($etablissements as $etablissement)
                                                    <option value="{{ $etablissement->id}}">
                                                        {{ $etablissement->nom_etablissement }}
